...
#let container(name, title, desc, border_color) = rect(
  fill: white, stroke: 1.5pt + border_color, radius: 8pt, width: 220pt, inset: 12pt,
  grid(
    columns: (1.5cm, 1fr),
    align: horizon + left,
    icon(name, w: 1.3cm),
...
#align(center)[
  #rect(fill: rgb("f1f5f9"), stroke: 2pt + rgb("94a3b8"), radius: 12pt, inset: 30pt, width: auto)[
    #align(left)[
    ...
    #grid(
      ...
      // TIER 1: Presentation
      rect(fill: rgb("fff1f2"), stroke: 1.5pt + rgb("f43f5e"), radius: 8pt, inset: 15pt, width: 260pt, height: 200pt)[
      ...
      // TIER 2: Application
      rect(fill: rgb("eff6ff"), stroke: 1.5pt + rgb("3b82f6"), radius: 8pt, inset: 15pt, width: 260pt, height: 200pt)[
      ...
      rect(fill: rgb("f8fafc"), stroke: 1.5pt + rgb("cbd5e1"), radius: 8pt, inset: 15pt, width: 260pt, height: 200pt)[
