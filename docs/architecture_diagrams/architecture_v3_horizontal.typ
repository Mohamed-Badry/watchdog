...
// End Users
#place(dx: 1400pt, dy: 270pt)[
  #rect(fill: white, stroke: 2pt + rgb("64748b"), radius: 12pt, width: 260pt, height: 260pt)[
    #place(dx: 20pt, dy: 20pt)[#text(size: 14pt, weight: "bold", fill: rgb("334155"))[End Users]]
  ]
]
...
#elbow_right(630pt, 220pt, 750pt, 370pt, "Webhook")
#elbow_right(630pt, 520pt, 750pt, 370pt, "MQTT Sub")

#elbow_bidir(970pt, 370pt, 1090pt, 220pt, "Tensors / Scores")
#elbow_bidir(970pt, 370pt, 1090pt, 520pt, "Read / Write")
...
#place(dx: 1560pt - 130pt, dy: 370pt - 60pt)[
