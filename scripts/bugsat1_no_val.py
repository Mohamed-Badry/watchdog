        ...
        def _read(self):
            ...
            if self.beacon_id0 == 255:
                ...
                if not self.beacon_id1 == b"\xFF":
                    pass # raise kaitaistruct.ValidationNotEqualError(b"\xFF", self.beacon_id1, self._io, u"/types/ax25_info_data/seq/1")

            if self.beacon_id0 == 255:
                self.beacon_id2 = self._io.read_bytes(1)
                if not self.beacon_id2 == b"\xF0":
                    pass # raise kaitaistruct.ValidationNotEqualError(b"\xF0", self.beacon_id2, self._io, u"/types/ax25_info_data/seq/2")
    ...
    class Telemetry(KaitaiStruct):
        ...
        def _read(self):
            ...
            if not self.platform_id == b"\x00\x01":
                pass # raise kaitaistruct.ValidationNotEqualError(b"\x00\x01", self.platform_id, self._io, u"/types/telemetry/seq/0")
            ...
            if not self.mem_tlm_id == b"\x01\x01":
                pass # raise kaitaistruct.ValidationNotEqualError(b"\x01\x01", self.mem_tlm_id, self._io, u"/types/telemetry/seq/6")
            self.free = self._io.read_u4be()
            self.cdh_id = self._io.read_bytes(2)
            if not self.cdh_id == b"\x02\x01":
                pass # raise kaitaistruct.ValidationNotEqualError(b"\x02\x01", self.cdh_id, self._io, u"/types/telemetry/seq/8")
            ...
            if not self.pwr_tlm_id == b"\x03\x01":
                pass # raise kaitaistruct.ValidationNotEqualError(b"\x03\x01", self.pwr_tlm_id, self._io, u"/types/telemetry/seq/11")
            ...
            if not self.thermal_tlm_id == b"\x04\x01":
                pass # raise kaitaistruct.ValidationNotEqualError(b"\x04\x01", self.thermal_tlm_id, self._io, u"/types/telemetry/seq/20")
            ...
            if not self.aocs_tlm_id == b"\x05\x01":
                pass # raise kaitaistruct.ValidationNotEqualError(b"\x05\x01", self.aocs_tlm_id, self._io, u"/types/telemetry/seq/23")
            ...
            if not self.payload_tlm_id == b"\x06\x01":
                pass # raise kaitaistruct.ValidationNotEqualError(b"\x06\x01", self.payload_tlm_id, self._io, u"/types/telemetry/seq/42")
